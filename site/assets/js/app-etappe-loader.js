...
document.addEventListener("DOMContentLoaded", async () => {
    try {
        ...
        if (stage.accommodation) {
            ...
            if (stage.accommodation.customIcon) {
                document.getElementById("acc-icon").textContent =
                    stage.accommodation.customIcon;
                document.getElementById("acc-title").textContent = "Tourende";
            }
            if (stage.accommodation.link) {
                document.getElementById("acc-link").href =
                    stage.accommodation.link;
            }
        }
